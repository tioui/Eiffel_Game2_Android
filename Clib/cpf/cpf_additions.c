...
int64_t cpfFileTell(void* UserData)
{
	...
	return SDL_RWtell((SDL_RWops*)(cpfInfos->filePtr))-cpfInfos->StartOffset;
}
...
int64_t cpfFileSeek(int64_t Offset, int Whence, void* UserData)
{
	...
	SDL_RWseek((SDL_RWops*)(cpfInfos->filePtr),Position+cpfInfos->StartOffset,RW_SEEK_SET);
...
int64_t cpfFileRead(void* Ptr, int64_t Count, void* UserData)
{
	...
	Count=SDL_RWread((struct SDL_RWops*) (cpfInfos->filePtr), Ptr, 1, Count);
